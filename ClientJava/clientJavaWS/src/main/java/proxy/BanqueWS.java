 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://ws.miaad.org/", wsdlLocation = "http://localhost:9191/banqueService?wsdl")
    ...
    extends Service
{
    ...
    private static final QName BANQUEWS_QNAME = new QName("http://ws.miaad.org/", "BanqueWS");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://ws.miaad.org/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.miaad.org/", "BanqueServicePort"), BanqueService.class, features);
    }
